...
function SignaturePad (selector, options) {
  ...
  function drawLine (e, newYOffset) {
    ...
    if (typeof e.changedTouches !== 'undefined') {
      newX = ((parseInt(e.changedTouches[0].pageX - offset.left) - xTranslation) / scale) - afterScaleXTranslation
      newY = ((parseInt(e.changedTouches[0].pageY - offset.top) - yTranslation) / scale) - afterScaleYTranslation
    } else {
      newX = (parseInt(e.pageX - offset.left - xTranslation) / scale) - afterScaleXTranslation
      newY = (parseInt(e.pageY - offset.top - yTranslation) / scale) - afterScaleYTranslation
    }
  ...
  function resetCanvas() {
    ...
    yTranslation = 0
    scale = 1
    afterScaleXTranslation = 0
    afterScaleYTranslation = 0
 ...
 var yTranslation = 0
 var scale = 1
 var afterScaleXTranslation = 0
 var afterScaleYTranslation = 0
  ...
  function drawSignature (paths, context, saveOutput) {
    ...
    scale = scaleFactor
    xTranslation = -minX * scaleFactor
    yTranslation = -minY * scaleFactor
    afterScaleXTranslation = (canvas.width() / scaleFactor - signatureWidth) / 2
    afterScaleYTranslation = (canvas.height() / scaleFactor - signatureHeight) / 2
